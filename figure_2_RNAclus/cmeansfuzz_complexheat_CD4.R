...
smpl_order = c("CD4_Nav_unstim", "CD4_CM_unstim", "CD4_EM_unstim")
files = files[order(match(files$cellSubtype, smpl_order)),]

#Read in dataset with k-means cluster values
input_dir <- "kmeans"
input_file <- "CD4_unstim_labfilter_RNA_fuzzmeans_clusterdata_v2.txt"
...
#genes_highlight <- c("LDHB","PFKFB2","AQP3","PDK1", "IGF1R", "PDCD1", "OGDH", "PGAM1", "HLA-DRA", "MKI67", "DUSP4",  "GAPDH", "IFNG", "PDP1", "IL2RA","GZMB", "LEF1", "CPT1A", "ICOS", "PRF1", "CD28", "CTLA4", "CCR7", "IL6R", "IL7R", "PRDM1", "KLRG1", "SELL", "CD27", "TBX21", "EOMES", "BATF")
genes_highlight <- c("ELOVL5","HLA−DRB1","IGF1R","TCF7","RORA","RORC", "LDHB","PFKFB2","BACH1","BACH2", "TCF3","GABPA","NRF1","PDK1","JUNB", "JUND", "AHR", "HIF1A", "TP73", "PDCD1", "OGDH", "PGAM1", "MKI67", "DUSP4",  "GAPDH", "IFNG", "PDP1", "IL2RA","GZMB", "LEF1", "ICOS", "PRF1", "CD28", "CTLA4", "CCR7",'FOXP1',  "IL7R", "PRDM1", "KLRG1", "SELL", "CD27", "TBX21", "EOMES", "BATF")
#Select k
k = 5
subset = "CD4_unstim_labfilterOct07"
...
em.col = "#FFB74CFF"
#emra.col ="#870D4EFF"
cellcolors = c("CD4_Nav_unstim"=nav.col,
               "CD4_CM_unstim"=cm.col,
               "CD4_EM_unstim"=em.col)
