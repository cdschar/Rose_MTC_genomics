...
output_dir <- "barplots/proteinfig"
...
for (i in 1:length(gene)){  
  ...
  ggsave(here(output_dir, paste(gene[i], "stimunstim_noEMRA.pdf", sep="")), width=7, height=5)
  ggsave(here(output_dir, paste(gene[i], "stimunstim_noEMRA.jpg", sep="")), width=7, height=5)
}   