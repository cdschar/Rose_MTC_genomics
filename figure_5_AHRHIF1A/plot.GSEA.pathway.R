...
homeDir = "~/Documents/Emory/Boss/data/RNA/GSEA/Analysis/PageRank_Networks/";
#setwd(homeDir);

#read in collapsed PreRanked Gene list used for GSEA (resides in the "edb" folder in the output directory)(
geneListDir = "/home/jim/Documents/Emory/Boss/data/RNA/GSEA/rnk_files/";
geneListFile = "CD8_CM_blood_unstim.v.CD8_EM_blood_unstim.rnk";
...
dataDir = "/home/jim/Documents/Emory/Boss/data/RNA/GSEA/PageRank_Networks/";
dataFile = "CD8_CM_EM_PgRnk_hits.GseaPreranked.1634131408035/AHR.xls";
...
layout(matrix(1:3, nrow = 3), widths = 1, heights = c(1.25, 0.5, 0.75))
