...
```{r}
write.xlsx(reform_df, '~/Dropbox/PhD/Tmem/data/exports/8g.xlsx')
```
...
export <- RNA_sub2 %>% select(CD4_EM_blood_unstim.v.CD4_Nav_blood_unstim.logFC, CD4_EM_blood_stim.v.CD4_Nav_blood_stim.logFC, PrimeState, IndState)

write.xlsx(export, '~/Dropbox/PhD/Tmem/data/exports/8de.xlsx')
```
...
```{r}
write.xlsx(CD4_per_prime, '~/Dropbox/PhD/Tmem/data/exports/8f.xlsx')
```
