...
homeDir = "/Volumes/ESB/Boss_Projects/Human_Tcell_subsets/ATAC_combined/analysis/pca/";
setwd(homeDir);
...
#plot
cairo_pdf(paste0(gsub(".txt", "", dataFile), ".PCAconfidence.", dim(data)[1], ".items.pc", p1, ".v.pc", p2, "_noCD4emra_stim_unstim", ".pdf"), height = 5, width = 5)
...
legend("topright", legend = unique(files$group), text.col = grpCols,col = grpCols, pch =rep(c(17,19), 7), bty = "n", cex=0.6)
dev.off();
